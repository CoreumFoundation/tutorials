  ...
  toJSON(message: Params): unknown {
    ...
    message.model !== undefined &&
      (obj.model = message.model
        ? ModelParams.toJSON(message.model)
        : undefined);
    return obj;
  },
