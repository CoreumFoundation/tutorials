      ...
      <Card sx={{ display: 'flex', gap: 2, alignItems: 'center', padding: 2 }}>
        ...
        <CardContent>
          <Typography variant="body1">
            Welcome to 'EtherScape', a game built on Unity, enriched with Web3.
            Dive into a universe where assets are unique NFTs. Trade items,
            engage in quests, and be part of a community that merges gaming with
            real-world value. Powered by Unity's graphics and blockchain's
            decentralization.
          </Typography>
        </CardContent>
      </Card>
