...
import {
  ...
  VoteResponse,
  VoterResponse,
} from './Cw3FlexMultisigNamed.types';
...
export class Cw3FlexMultisigNamedQueryClient
  implements Cw3FlexMultisigNamedReadOnlyInterface
{
...
export interface Cw3FlexMultisigNamedInterface
  extends Cw3FlexMultisigNamedReadOnlyInterface {
  contractAddress: string;
  sender: string;
  propose: (
    {
...
export class Cw3FlexMultisigNamedClient
  extends Cw3FlexMultisigNamedQueryClient
  implements Cw3FlexMultisigNamedInterface
{
