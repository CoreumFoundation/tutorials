...
function createBaseParams(): Params {
  return { issueFee: undefined, tokenUpgradeDecisionTimeout: undefined, tokenUpgradeGracePeriod: undefined };
}
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.tokenUpgradeDecisionTimeout !== undefined) {
      obj.tokenUpgradeDecisionTimeout = message.tokenUpgradeDecisionTimeout.toISOString();
    }
    if (message.tokenUpgradeGracePeriod !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.tokenUpgradeGracePeriod =
      (object.tokenUpgradeGracePeriod !== undefined && object.tokenUpgradeGracePeriod !== null)
