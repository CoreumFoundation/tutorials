...
export class QueryClientImpl implements Query {
  ...
  Frozen(request: QueryFrozenRequest): Promise<QueryFrozenResponse> {
    ...
    return promise.then((data) =>
      QueryFrozenResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  Whitelisted(
    ...
    return promise.then((data) =>
      QueryWhitelistedResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  WhitelistedAccountsForNFT(
    ...
    return promise.then((data) =>
      QueryWhitelistedAccountsForNFTResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  BurntNFT(request: QueryBurntNFTRequest): Promise<QueryBurntNFTResponse> {
    ...
    return promise.then((data) =>
      QueryBurntNFTResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  BurntNFTsInClass(
    ...
    return promise.then((data) =>
      QueryBurntNFTsInClassResponse.decode(_m0.Reader.create(data)),
    );
  }
}
