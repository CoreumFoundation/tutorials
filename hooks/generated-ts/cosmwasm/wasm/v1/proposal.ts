...
export const StoreCodeProposal = {
  ...
  create<I extends Exact<DeepPartial<StoreCodeProposal>, I>>(
    base?: I,
  ): StoreCodeProposal {
...
export const InstantiateContract2Proposal = {
  ...
  create<I extends Exact<DeepPartial<InstantiateContract2Proposal>, I>>(
    base?: I,
  ): InstantiateContract2Proposal {
...
export const MigrateContractProposal = {
  ...
  create<I extends Exact<DeepPartial<MigrateContractProposal>, I>>(
    base?: I,
  ): MigrateContractProposal {
...
export const SudoContractProposal = {
  ...
  create<I extends Exact<DeepPartial<SudoContractProposal>, I>>(
    base?: I,
  ): SudoContractProposal {
...
export const ExecuteContractProposal = {
  ...
  create<I extends Exact<DeepPartial<ExecuteContractProposal>, I>>(
    base?: I,
  ): ExecuteContractProposal {
...
export const UpdateAdminProposal = {
  ...
  create<I extends Exact<DeepPartial<UpdateAdminProposal>, I>>(
    base?: I,
  ): UpdateAdminProposal {
...
export const ClearAdminProposal = {
  ...
  create<I extends Exact<DeepPartial<ClearAdminProposal>, I>>(
    base?: I,
  ): ClearAdminProposal {
...
export const PinCodesProposal = {
  ...
  create<I extends Exact<DeepPartial<PinCodesProposal>, I>>(
    base?: I,
  ): PinCodesProposal {
...
export const UnpinCodesProposal = {
  ...
  create<I extends Exact<DeepPartial<UnpinCodesProposal>, I>>(
    base?: I,
  ): UnpinCodesProposal {
...
export const AccessConfigUpdate = {
  ...
  create<I extends Exact<DeepPartial<AccessConfigUpdate>, I>>(
    base?: I,
  ): AccessConfigUpdate {
...
export const StoreAndInstantiateContractProposal = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<StoreAndInstantiateContractProposal>, I>,
  >(object: I): StoreAndInstantiateContractProposal {
    const message = createBaseStoreAndInstantiateContractProposal();
    message.title = object.title ?? '';
    message.description = object.description ?? '';
    message.runAs = object.runAs ?? '';
